  ...
  if (symMatch) {
    ...
    if (!isNaN(nom) && !isNaN(tolVal)) {
      return {
        ...
        lowerLimit: nom - tolVal,
        upperLimit: nom + tolVal,
        unit: defaultUnit,
  ...
  if (dualMatch) {
    ...
    if (!isNaN(nom) && !isNaN(v1) && !isNaN(v2)) {
      ...
      return {
        ...
        lowerLimit: nom + lowerTol,
        upperLimit: nom + upperTol,
        unit: defaultUnit,
        decimalPrecision: dec,
        isValid: true,
      };
  ...
  if (plainMatch) {
    ...
    if (!isNaN(nom)) {
      return {
        ...
        lowerTolerance: -defaultTolerance,
        upperTolerance: defaultTolerance,
        lowerLimit: nom - defaultTolerance,
        upperLimit: nom + defaultTolerance,
        unit: defaultUnit,
        decimalPrecision: dec,
        isValid: true,
      };
