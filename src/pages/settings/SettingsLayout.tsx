...
export default function SettingsLayout({ defaultTab = "mail", tabs }: SettingsLayoutProps) {
    return (
        <div className="w-full bg-background overflow-hidden" style={{ height: "90vh" }}>
            <div className="max-w-7xl mx-auto h-full flex">

                <Tabs defaultValue={defaultTab} orientation="horizontal" className="flex w-full">

                    {/* Left Sidebar - fixed height, no scrolling */}
                    <Card className="w-80 h-full bg-settings-nav border-border/50 flex-shrink-0 overflow-hidden">
                        <div className="p-6">
                            <TabsList className="flex flex-col space-y-2 w-full bg-transparent p-0 h-auto">
                                {tabs.map((tab) => (
                                    <TabsTrigger
