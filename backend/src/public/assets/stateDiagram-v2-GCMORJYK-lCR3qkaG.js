...
`,"getStyles"),Qe=qe,os={parser:be,get db(){return new Xe(2)},renderer:Ke,styles:Qe,init:p(t=>{t.state||(t.state={}),t.state.arrowMarkerAbsolute=t.arrowMarkerAbsolute},"init")};export{os as diagram};
