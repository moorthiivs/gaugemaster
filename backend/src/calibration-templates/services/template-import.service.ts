        ...
        if (item.status === 'DUPLICATE') {
          ...
          if (duplicateStrategy === 'REPLACE' && item.existingId) {
            await queryRunner.manager.update(CalibrationTemplate, item.existingId, {
              ...
              procedure_no: spec.procedure_no,
              procedure_name: spec.procedure_name,
              procedure_date: spec.procedure_date,
              procedure_rev: spec.procedure_rev,
              doc_no: spec.doc_no,
              doc_date: spec.doc_date,
              doc_rev: spec.doc_rev,
              acceptance_criteria_doc_no: spec.acceptance_criteria_doc_no,
              acceptance_criteria_date: spec.acceptance_criteria_date,
              acceptance_criteria_rev: spec.acceptance_criteria_rev,
              acceptance_criteria_reference: spec.acceptance_criteria_reference,
