...
let DashboardController = class DashboardController {
    ...
    async fetch(id, startDate, endDate, itemStatus, status, location) {
        return this.dashboardService.fetchDashboard(id, startDate, endDate, itemStatus, status, location);
    }
    async fetchList(id, listType, startDate, endDate, itemStatus, status, location) {
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('itemStatus')),
    __param(4, (0, common_1.Query)('status')),
    __param(5, (0, common_1.Query)('location')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, String, String]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "fetch", null);
__decorate([
    (0, common_1.Get)(":id/list"),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)('listType')),
    __param(2, (0, common_1.Query)('startDate')),
    __param(3, (0, common_1.Query)('endDate')),
    __param(4, (0, common_1.Query)('itemStatus')),
    __param(5, (0, common_1.Query)('status')),
    __param(6, (0, common_1.Query)('location')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, String, String, String]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "fetchList", null);
